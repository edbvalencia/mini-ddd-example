...
public class MatchFinishedDomainEvent extends DomainEvent {
    ...
    public MatchFinishedDomainEvent(String matchId, String teamHome, String teamAway, ZonedDateTime startDate, String status) {
        super(matchId);
    ...
    public DomainEvent fromPrimitives(String aggregateId, HashMap<String, Serializable> body,
        ...
        return new MatchFinishedDomainEvent(
                aggregateId,
